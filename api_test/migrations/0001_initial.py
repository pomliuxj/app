# Generated by Django 3.1 on 2022-05-25 00:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('httpType', models.CharField(choices=[('HTTP', 'HTTP'), ('HTTPS', 'HTTPS'), ('DUBBO', 'DUBBO')], default='HTTP', max_length=50, verbose_name='http/https')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(blank=True, max_length=50, null=True, verbose_name='数据源名称')),
                ('user', models.CharField(blank=True, max_length=50, null=True, verbose_name='数据库用户')),
                ('password', models.CharField(blank=True, max_length=50, null=True, verbose_name='数据库用户')),
                ('host', models.CharField(blank=True, max_length=50, null=True, verbose_name='数据库ip或域名')),
                ('port', models.IntegerField(blank=True, null=True, verbose_name='数据库端口')),
                ('db', models.CharField(blank=True, max_length=50, null=True, verbose_name='要选择的数据库')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api_test.project', verbose_name='项目')),
            ],
            options={
                'verbose_name': '全局变量',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(blank=True, default=None, max_length=50, unique=True, verbose_name='字段名称')),
                ('excutesql', models.TextField(default=None, verbose_name='数据执行sql')),
                ('pre_excute', models.BooleanField(default=True, verbose_name='是否前置执行')),
                ('type', models.CharField(choices=[('mysql', 'MYSQL'), ('redis', 'REDIS'), ('mq', 'MQ')], max_length=10, verbose_name='数据类型')),
                ('AutomationCaseApi', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='CaseDataExcutedatail', to='api_test.automationcaseapi', verbose_name='接口id')),
                ('dataInfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='databaseinfodetail', to='api_test.databaseinfo', verbose_name='数据库配置详情')),
                ('project', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api_test.project', verbose_name='项目')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caseId', models.CharField(max_length=50, null=True, verbose_name='选中case')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taskName', models.CharField(max_length=50, null=True, verbose_name='任务名称')),
                ('taskResult', models.BooleanField(default=True, verbose_name='任务执行结果')),
                ('caseRunDetail', models.CharField(max_length=1024, null=True, verbose_name='用例执行明细')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.project', verbose_name='项目')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='AutomationJsonCheck',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(blank=True, max_length=50, null=True, verbose_name='JSON名称')),
                ('checkType', models.CharField(choices=[('gte', '大于'), ('lte', '小于'), ('equal', '等于'), ('contain', '包含'), ('notNull', '不为空')], max_length=50, verbose_name='校验方式')),
                ('checkRule', models.CharField(blank=True, max_length=512, null=True, verbose_name='JSON名称')),
                ('value', models.TextField(blank=True, null=True, verbose_name='检验值')),
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jsonCheckDetail', to='api_test.automationcaseapi', verbose_name='接口id')),
            ],
            options={
                'verbose_name': '结果JSON参数',
                'verbose_name_plural': '结果JSON参数管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(blank=True, max_length=2048, null=True, verbose_name='内容')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'index_together': {('automationCaseApi', 'testTime')},
            },
        ),
    ]
