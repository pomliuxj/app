...
from api_test.api.projectList import Projection,\
    EnableProject, DisableProject
from api_test.api.projectTitle import ProjectInfo
from api_test.api.TaskInfo import TaskInfo, TaskRecode

urlpatterns = [
    # ── 账号权限管理 ──────────────────────────────────────────────
    url(r'account/user_list', account.UserList.as_view()),
    url(r'account/user_detail', account.UserDetail.as_view()),
    url(r'account/user_create', account.UserCreate.as_view()),
    url(r'account/user_update', account.UserUpdate.as_view()),
    url(r'account/user_password_reset', account.UserPasswordReset.as_view()),
    url(r'account/user_toggle_active', account.UserToggleActive.as_view()),
    # ── 项目成员管理 ──────────────────────────────────────────────
    url(r'member/add_member', project_member.ProjectMemberAdd.as_view()),
    ...
    url(r'global/global_variables', GlobalOnlineCode.as_view()),    
    url(r'global/global_database', GlobalDataBase.as_view()),
    url(r'global/global_checkdatabase', CheckDataBase.as_view()),
    ...
    url(r'api/fast_test', ApiDoc.FastTest.as_view()),
    ...
    url(r'automation/start_test_sequential', Case.StartTestSequential.as_view()),
    ...
    url(r'automation/TaskInfo', TaskInfo.as_view()),
    url(r'automation/look_result', Case.LookResult.as_view()),
    url(r'automation/test_report', Case.TestReport.as_view()),
    url(r'automation/global_testrundatacase', testRunDataCase.as_view()),
    url(r'automation/global_casedatabasecheck', CaseDatabaseCheck.as_view()),
    ...
    url(r'user/register', register.Register.as_view()),
    url(r'user/VisitorRecord', VisitorRecord.Record.as_view()),
    url(r'automation/TaskRecode', TaskRecode.as_view()),
